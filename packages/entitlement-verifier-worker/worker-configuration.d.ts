/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false` (hash: 9c64266d39e33d6c3cd0de1b8a8f2040)
// Runtime types generated with workerd@1.20260910.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	VERIFICATION_RATE_LIMITER: RateLimit;
	PROVIDER_RATE_LIMITER: RateLimit;
	DEPLOYMENT_ENVIRONMENT: string;
	EXPECTED_HOSTNAME: string;
	ALLOWED_BROWSER_ORIGINS: string;
	GOOGLE_PLAY_PACKAGE_NAME: string;
	GOOGLE_PLAY_PRODUCT_ID: string;
	GOOGLE_PLAY_ALLOW_TEST_PURCHASES: string;
	SAMSUNG_CHECKOUT_APP_ID: string;
	SAMSUNG_PREMIUM_PRODUCT_ID: string;
	GOOGLE_SERVICE_ACCOUNT_EMAIL: string;
	GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	SAMSUNG_DPI_SECURITY_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_ENVIRONMENT" | "EXPECTED_HOSTNAME" | "ALLOWED_BROWSER_ORIGINS" | "GOOGLE_PLAY_PACKAGE_NAME" | "GOOGLE_PLAY_PRODUCT_ID" | "GOOGLE_PLAY_ALLOW_TEST_PURCHASES" | "SAMSUNG_CHECKOUT_APP_ID" | "SAMSUNG_PREMIUM_PRODUCT_ID" | "GOOGLE_SERVICE_ACCOUNT_EMAIL" | "GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY" | "SAMSUNG_DPI_SECURITY_KEY" | "RATE_LIMIT_KEY_SECRET">> {}
}
