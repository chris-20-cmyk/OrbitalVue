...
const FAVORITES_KEY = "orbitalvue-tv-favorites-v1";
...
export class OrbitalVueTvApp {
  ...
  private catalog: OrbitalVueCatalog | null = null;
  ...
  private requireCatalog(): OrbitalVueCatalog {
...
function sourceStatus(catalog: OrbitalVueCatalog): string {
  if (catalog.catalogId === "orbitalvue-demo") return "Source refreshed 2m ago";
