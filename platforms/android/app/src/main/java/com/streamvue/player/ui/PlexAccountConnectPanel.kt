...
import com.streamvue.player.data.MediaCenterUrlPolicy
import com.streamvue.player.data.PlexDiscoveredServer
import com.streamvue.player.data.PlexServerConnectionChoice
...
private fun PreparingPlexSignIn() {
    Row(verticalAlignment = Alignment.CenterVertically) {
        CircularProgressIndicator(modifier = Modifier.size(20.dp), strokeWidth = 2.dp, color = StreamVueTeal)
        Spacer(modifier = Modifier.width(10.dp))
        Text("Preparing secure Plex sign-in…", color = StreamVueText, fontWeight = FontWeight.SemiBold)
    }
}
...
private fun PlexSignInChallenge(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Spacer(modifier = Modifier.height(10.dp))
        Row(verticalAlignment = Alignment.CenterVertically) {
            CircularProgressIndicator(modifier = Modifier.size(17.dp), strokeWidth = 2.dp, color = StreamVueTeal)
            Spacer(modifier = Modifier.width(8.dp))
            Text("Waiting for approval", color = StreamVueMuted, fontSize = 10.sp)
        }
...
private fun PlexServerPicker(
    discovery: com.streamvue.player.data.PlexServerDiscovery,
