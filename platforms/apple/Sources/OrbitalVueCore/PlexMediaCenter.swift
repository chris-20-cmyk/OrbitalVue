...
struct PlexMediaCenterClient: Sendable {
    ...
    private func pathComponent(_ value: String) -> String {
        value.addingPercentEncoding(withAllowedCharacters: .orbitalVuePathComponentAllowed) ?? value
    }
    ...
    private func isoDate(epochSeconds: Int?) -> String? {
        ...
        return ISO8601DateFormatter.orbitalVueString(from: date)
    }
}
...
extension CharacterSet {
    static let orbitalVuePathComponentAllowed = CharacterSet.alphanumerics
