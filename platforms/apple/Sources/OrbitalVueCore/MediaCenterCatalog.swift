...
public enum MediaCenterCatalogFactory {
    public static func create(from snapshot: MediaCenterSnapshot) throws -> OrbitalVueCatalog {
        guard snapshot.contractVersion == orbitalVueMediaCenterContractVersion else {
