...
public enum StreamVueDistributionMode: String, Codable, Sendable {
    case personal
    case store
    case unknown
}
...
public struct PremiumAccessSnapshot: Codable, Equatable, Sendable {
    ...
    public let distributionMode: StreamVueDistributionMode
...
public enum PremiumAccessPolicy {
    ...
    public static var current: PremiumAccessSnapshot {
        let configuredMode = Bundle.main.object(
            forInfoDictionaryKey: "StreamVueDistributionMode"
        ) as? String
        return evaluate(
    ...
    public static func evaluate(
        ...
        let normalizedMode = distributionMode?
            ...
            .lowercased()
        let mode: StreamVueDistributionMode = switch normalizedMode {
    ...
    private static func snapshot(
        mode: StreamVueDistributionMode,
