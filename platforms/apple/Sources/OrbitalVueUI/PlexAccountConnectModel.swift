...
final class PlexAccountConnectModel {
    ...
    func start(using store: OrbitalVueStore) async {
    ...
    func poll(using store: OrbitalVueStore) async {
    ...
    func connect(using store: OrbitalVueStore, onConnected: () -> Void) async {
    ...
    func cancel(using store: OrbitalVueStore) async {
