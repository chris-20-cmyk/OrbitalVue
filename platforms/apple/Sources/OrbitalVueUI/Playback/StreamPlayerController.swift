...
public final class StreamPlayerController {
    ...
    let ksVideoView = OrbitalVueKSVideoView()
    #endif

    private var settings: OrbitalVueSettings?
    ...
    public func configure(settings: OrbitalVueSettings) {
        ...
        ksVideoView.allowsOrbitalVuePictureInPicture = settings.allowsPictureInPicture
        ksVideoView.preferredSubtitleLanguage = settings.preferredSubtitleLanguage
        ksVideoView.orbitalVueSubtitleFontSize = CGFloat(settings.ksSubtitleFontSize)
        ksVideoView.refreshOrbitalVueSubtitleStyle()
    ...
    #if canImport(KSPlayer)
    private func prepareKSPlayer(channel: CatalogChannel, settings: OrbitalVueSettings) {
        ...
        let options = OrbitalVueKSOptions(
            adaptiveFrameRate: settings.ksAdaptiveFrameRate,
