...
| Platform | Final assets required by StreamVue's quality gate |
| --- | --- |
...
| Google Play | 512×512 32-bit PNG icon, 1024×500 opaque feature graphic, 1280×720 opaque Android TV banner, and four current screenshots each for phone, tablet, and TV. Google requires at least two screenshots overall, plus a TV screenshot and banner for Android TV; StreamVue keeps the stronger four-per-surface bar. |
| Apple | Four opaque screenshots each for iPhone 6.9-inch, iPad 13-inch, and Apple TV. StreamVue accepts current official sizes encoded in the validator; App Store Connect requires one to ten for every supported device class. The app icon continues to come from the reviewed Xcode asset catalog. |
