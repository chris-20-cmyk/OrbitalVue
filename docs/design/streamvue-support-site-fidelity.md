# StreamVue public site fidelity ledger

The generated overview and privacy concepts are the visual specification for the static public-site foundation:

- `docs/design/streamvue-support-site-overview-concept.png`
- `docs/design/streamvue-support-site-policy-concept.png`
...
| Overview hierarchy | Large three-line promise beside a player composition | Matched with responsive editorial copy and a generic, rights-safe StreamVue player illustration |
