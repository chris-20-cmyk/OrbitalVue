...
{
    private static readonly byte[] Entropy = Encoding.UTF8.GetBytes("OrbitalVue.XtreamCredentials.v1");
    ...
    {
        _credentialPath = credentialPath ?? OrbitalVueDataPaths.Resolve("xtream-credentials.v1.bin");
    }
