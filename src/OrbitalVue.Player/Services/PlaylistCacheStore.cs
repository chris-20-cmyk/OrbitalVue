...
{
    private static readonly byte[] Entropy = Encoding.UTF8.GetBytes("OrbitalVue.PlaylistCache.v1");
    ...
    {
        _legacyCachePath = cachePath ?? OrbitalVueDataPaths.Resolve("playlist-cache.v1.bin");
        _cacheDirectory = cacheDirectory ?? (cachePath is null ? OrbitalVueDataPaths.Resolve("playlist-caches.v2") : null);
    }
