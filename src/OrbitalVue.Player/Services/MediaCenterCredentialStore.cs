...
{
    private static readonly byte[] Entropy = Encoding.UTF8.GetBytes("OrbitalVue.MediaCenterCredentials.v1");
    ...
    {
        _credentialPath = credentialPath ?? OrbitalVueDataPaths.Resolve("media-center-credentials.v1.bin");
    }
