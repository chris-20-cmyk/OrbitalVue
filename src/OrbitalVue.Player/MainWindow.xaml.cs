...
public partial class MainWindow : Window
{
    ...
    private readonly OrbitalVueMaintenanceService _maintenanceService = new();
    ...
    private async void CreateBackup_Click(object sender, RoutedEventArgs e)
    {
        var dialog = new SaveFileDialog
        {
            ...
            AddExtension = true,
            Filter = "OrbitalVue backup (*.orbitalvue-backup)|*.orbitalvue-backup|Legacy OrbitalVue backup (*.orbitalvue-backup)|*.orbitalvue-backup"
        };
    ...
    private async void ExportDiagnostics_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            var context = new OrbitalVueDiagnosticContext(
                _channels.Count,
