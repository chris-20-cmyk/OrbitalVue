...
public sealed record PremiumStoreConfiguration(
    ...
    string? ProductId)
{
    public bool IsStoreBuild => DistributionMode == StreamVueDistributionMode.Store;
        ...
        get
        {
            ...
            var productId = typeof(PremiumStoreConfiguration).Assembly
                ...
                .SingleOrDefault(attribute =>
                    attribute.Key.Equals("StreamVuePremiumProductId", StringComparison.Ordinal))
                ?.Value;
    ...
    string? Message = null)
{
        ...
        PremiumAccessSnapshot? access = null)
    {
        ...
        access ??= PremiumAccessPolicy.Evaluate(
            ...
            {
                StreamVueDistributionMode.Personal => "personal",
                StreamVueDistributionMode.Store => "store",
                _ => "unknown"
            },
