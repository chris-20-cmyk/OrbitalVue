...
{
    Console.Error.WriteLine("Usage: OrbitalVue.PlaylistProbe <playlist.m3u>");
    return 2;
}
...
var cachePath = Path.Combine(Path.GetTempPath(), $"orbitalvue-playlist-probe-{Guid.NewGuid():N}.bin");
